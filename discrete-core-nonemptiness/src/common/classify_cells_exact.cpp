...
struct Q{
 long long p=0,q=1;
 Q(long long a=0,long long b=1){if(!b)throw runtime_error("zero denominator");if(b<0)a=-a,b=-b;long long g=std::gcd(llabs(a),b);p=a/g;q=b/g;}
};
Q operator+(Q a,Q b){__int128 p=(__int128)a.p*b.q+(__int128)b.p*a.q,q=(__int128)a.q*b.q;if(p>LLONG_MAX||p<LLONG_MIN||q>LLONG_MAX)throw overflow_error("Q+");return Q((long long)p,(long long)q);}
Q operator-(Q a,Q b){__int128 p=(__int128)a.p*b.q-(__int128)b.p*a.q,q=(__int128)a.q*b.q;if(p>LLONG_MAX||p<LLONG_MIN||q>LLONG_MAX)throw overflow_error("Q-");return Q((long long)p,(long long)q);}
Q operator-(Q a){return Q(-a.p,a.q);}
Q operator*(Q a,Q b){long long g1=std::gcd(llabs(a.p),b.q),g2=std::gcd(llabs(b.p),a.q);__int128 p=(__int128)(a.p/g1)*(b.p/g2),q=(__int128)(a.q/g2)*(b.q/g1);if(p>LLONG_MAX||p<LLONG_MIN||q>LLONG_MAX)throw overflow_error("Q*");return Q((long long)p,(long long)q);}
Q operator/(Q a,Q b){if(!b.p)throw runtime_error("Q/0");return a*Q(b.q,b.p);}
Q& operator+=(Q&a,Q b){return a=a+b;}Q& operator-=(Q&a,Q b){return a=a-b;}Q& operator*=(Q&a,Q b){return a=a*b;}Q& operator/=(Q&a,Q b){return a=a/b;}
bool operator<(Q a,Q b){return (__int128)a.p*b.q<(__int128)b.p*a.q;}bool operator>(Q a,Q b){return b<a;}bool operator<=(Q a,Q b){return !(b<a);}bool operator>=(Q a,Q b){return !(a<b);}bool operator==(Q a,Q b){return a.p==b.p&&a.q==b.q;}bool operator!=(Q a,Q b){return !(a==b);}
string qs(Q a){return to_string(a.p)+(a.q==1?"":"/"+to_string(a.q));}
struct LP{
